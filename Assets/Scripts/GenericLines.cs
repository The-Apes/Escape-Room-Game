...
public static class GenericLines
{
    ...
    {
        if (!linesByCategory.ContainsKey(category)) return string.Empty;

        var lines = linesByCategory[category];
        return lines[Random.Range(0, lines.Count)];
    }
    private static Dictionary<string, List<string>> linesByCategory = new Dictionary<string, List<string>>()
    {
        //Player//
